...
allTimeExpenseButtonWithCategory(String type) {
  ...
  for (int i = 0; i < reverseAllTimeDates.length; i++) {
    ...
    for (int j = 0; j < data.length; j++) {
      if (data[j].categoryType == CategoryType.expense && data[j].category.name == type) {
        DateTime localDate = DateTime.parse(data[j].date);
        String localDate1 = DateFormat('dd-MM-yyyy').format(localDate);
  ...
  for (int i = 0; i < reverseAllTimeDates.length; i++) {
    ...
    for (int j = 0; j < data.length; j++) {
        ...
        if (localDate1 == date2) {
          ...
          for (int i = 0; i < data.length; i++) {
            if (data[i].categoryType == CategoryType.income && data[i].category.name==type){
              if (localDate1 ==
                  DateFormat('dd-MM-yyyy').format(DateTime.parse(data[i].date))) {
                dateTotal = dateTotal + data[i].amount;
              }
                      ...
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "${currencySymboleUpdate.value} ${trackballDetails
                                  .point!.y.toString()}",
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                color: Colors.white,
...
//                     )
                  ...
                  primaryYAxis: NumericAxis(
                    majorGridLines: MajorGridLines(
                        width: 2, color: Colors.grey, dashArray: [2, 6]),
                  ...
                  primaryXAxis: CategoryAxis(
                    ...
                    axisLabelFormatter: (axisLabelRenderArgs) {
                      ...
                      //   labelCounter++;
                      //   if (labelCounter % ((chartData.length ~/ 12) + 1) != 0) {
                      //
                      //     hideGridLine= true ;
                      //
                      //
                      ...
                      if (cycleOrAllTime == 'All Time') {
                        ...
                        String one = formattedDate
                            .split(' ')
                            .first;
                        String two = formattedDate
                            .split(' ')
                            .last;
...
if(selectedCategory=='All'){
  ...
  allTimeExpenseButtonWithCategory(selectedCategory);
}
                            ...
                            setState(() {
                              ...
                              if (cycleOrAllTime == 'All Time') {
                                if(selectedCategory=='All'){
                                  ...
                                  allTimeIncomeButtonWithCategory(selectedCategory);
                                }
                ...
                child: Row(
                  children: [
                    GestureDetector(
                              ...
                              i++) {
                                ...
                                j++) {
                                  ...
                                  if (date2.isAfter(
                                    ...
                                    print(myweekList);
                                    print('Yes');
                                    double amountToAdd = data[i].categoryType ==
                                        CategoryType.income
                                        ? data[i].amount
                                        : -data[i].amount;
                        ...
                        child: Icon(
                          Icons.close, color: AppTheme.white, size: 16,)),
                    SizedBox(width: 5),
                    Container(
